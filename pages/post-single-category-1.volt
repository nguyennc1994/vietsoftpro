...
{% block content %}
    ...
    <section id="slider-sec" class="slider-sec" style="background: url('./img/blogs/blog-banner1.jpg');">
                ...
                <div class="crumbs">
                    <nav aria-label="breadcrumb" class="breadcrumb-items">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="single-blog.html">Single Blog</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="blog_detail">
                                    ...
                                    <div class="row cube-sec no-gutters">
                                        <div class="col-12 col-md-6 pr-0 pr-md-2 pb-3">
                                            <img src="{{ theme_path }}/assets/img/blogs/s8.jpg" alt="image">
                                        </div>
                                        <div class="col-12 col-md-6 pl-0 pl-md-2 pb-3">
                                            <img src="{{ theme_path }}/assets/img/blogs/s9.jpg" alt="image">
                                        </div>
                                        <div class="col-12">
                                            <img src="{{ theme_path }}/assets/img/blogs/s10.jpg" alt="image">
                                        </div>
                                    </div>
                                ...
                                <div class="posted_by">
                                    <div class="media row">
                                        <div class="col-12 col-lg-3">
                                            <img src="{{ theme_path }}/assets/img/blogs/writer.jpg" class="align-self-center mr-3 rounded-circle" alt="img">
                                        </div>
                                    ...
                                    <form>
                                        <div class="row my-form">
                                            ...
                                            <div class="col-12 text-center">
                                                <a href="#" class="btn anim-btn rounded-pill">Post Comment
